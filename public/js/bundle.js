...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2l0dGVuZ2VyIiwiYSI6ImNrNmdzYmQ5ZDJtb3Uza3BqenhjeWltcHEifQ.-rC28navd7CS_JdLLBnpOA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends map bounds for current location
...
var stripe = Stripe('pk_test_VhJKFk0tyZXeus91EoKmE3UC00RBBIFiZi');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              userPasswordForm.querySelector('.btn--save-password').textContent = 'Updating...'; //getting values
              ...
              passwordConfirm = userPasswordForm.querySelector('#password-confirm').value; //update db
